...
# Modified from the original ISAKMP code by Yaron Sheffer
# <yaronf.ietf@gmail.com>, June 2010.
...
class IKEv2_class(Packet):
    ...
    def guess_payload_class(self, payload):
        ...
        if np == 0:
            ...
            logging.debug(globals().get("IKEv2_payload_%s" %
                                        pt, IKEv2_payload))
...
class IKEv2(IKEv2_class):  # rfc4306
    ...
    fields_desc = [
        ...
        FlagsField("flags", 0, 8, [
                   "res0", "res1", "res2", "Initiator", "Version", "Response", "res6", "res7"]),
        IntField("id", 0),
...
class IKEv2_Key_Length_Attribute(IntField):
        # We only support the fixed-length Key Length attribute (the only one
        # currently defined)
...
class IKEv2_payload_Transform(IKEv2_class):
    ...
    fields_desc = [
        ...
        ByteField("res2", 0),
        MultiEnumField("transform_id", None, IKEv2TransformNum,
                       depends_on=lambda pkt: pkt.transform_type, fmt="H"),
        ConditionalField(IKEv2_Key_Length_Attribute(
            "key_length"), lambda pkt: pkt.length > 8),
    ]
...
class IKEv2_payload_Proposal(IKEv2_class):
    ...
    fields_desc = [
        ...
        ), IKEv2_payload_Transform, length_from=lambda x: x.length - 8),
    ]
...
class IKEv2_payload(IKEv2_class):
    ...
    fields_desc = [
        ...
        FlagsField("flags", 0, 8, [
                   "critical", "res1", "res2", "res3", "res4", "res5", "res6", "res7"]),
...
class IKEv2_payload_SA(IKEv2_class):
    ...
    fields_desc = [
        ...
        PacketLenField("prop", conf.raw_layer(),
                       IKEv2_payload_Proposal, length_from=lambda x:x.length - 4),
    ]
...
class IKEv2_payload_Notify(IKEv2_class):
    ...
    fields_desc = [
        ...
        ByteEnumField("proto", None, {
                      0: "Reserved", 1: "IKE", 2: "AH", 3: "ESP"}),
        FieldLenField("SPIsize", None, "SPI", "B"),
...
class IKEv2_payload_IDi(IKEv2_class):
    ...
    fields_desc = [
        ...
        ByteEnumField("IDtype", 1, {
                      1: "IPv4_addr", 2: "FQDN", 3: "Email_addr", 5: "IPv6_addr", 11: "Key"}),
...
class IKEv2_payload_CERTREQ(IKEv2_class):
    ...
    fields_desc = [
        ByteEnumField("next_payload", None, IKEv2_payload_type),
        ByteField("res", 0),
        FieldLenField("length", None, "cert_data",
                      "H", adjust=lambda pkt, x:x + 5),
...
bind_layers(UDP,           IKEv2,        dport=500,
            sport=500)  # TODO: distinguish IKEv1/IKEv2
